...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_train_size", type=int, default=62500)
    parser.add_argument("--min_train_size", type=int, default=2500)
    ...
    parser.add_argument("--step_train_size", type=int, default=2500)
